...
function workOnRHSParent(
  ...
  if (
    ptr.type !== "MemberExpression" &&
    ptr.type !== "OptionalMemberExpression"
  )
...
function hasCallParent(ptr) {
  return (
    ptr.parentPath.type === "CallExpression" ||
    ptr.parentPath.type === "OptionalCallExpression"
  );
}
// will be hoisting up
