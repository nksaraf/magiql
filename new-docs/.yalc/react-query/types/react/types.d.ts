...
export interface UseQueryObserverOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryData = TQueryFnData> extends QueryObserverOptions<TQueryFnData, TError, TData, TQueryData> {
}
export interface UseQueryOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData> extends UseQueryObserverOptions<TQueryFnData, TError, TData> {
}
