...
import { Panel, QueryKeys, QueryKey, Button, Code, Input, Select, QueryCountStyles, ActiveQueryPanel } from './styledComponents';
...
export function ReactQueryDevtools(_ref) {
  ...
  })), isResolvedOpen ? /*#__PURE__*/React.createElement(Button, _extends({}, otherCloseButtonProps, {
  ...
  }), "Close") : null), !isResolvedOpen ? /*#__PURE__*/React.createElement("button", _extends({}, otherToggleButtonProps, {
...
export var ReactQueryDevtoolsPanel = /*#__PURE__*/React.forwardRef(function ReactQueryDevtoolsPanel(props, ref) {
  ...
  var _useLocalStorage5 = useLocalStorage('reactQueryDevtoolsActiveQueryHash', ''),
  ...
  }, /*#__PURE__*/React.createElement(QueryCountStyles, null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontWeight: 'bold'
    }
